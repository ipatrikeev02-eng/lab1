...
На вход программа получает два числа, при этом в условии не сказано к какому множеству они принадлежат, поэтому будем считать их вещественными. Заметим, что ограничения по длине числа нет, поэтому числа ограничиваются только границами типа данных double.
